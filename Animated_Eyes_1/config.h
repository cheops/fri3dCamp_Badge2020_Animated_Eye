...
#define EYE_1_XPOSITION  56         // x shift for eye 1 image on display
#define EYE_2_XPOSITION  240 - 128 // x shift for eye 2 image on display
...
#define BLINK_PIN   0  // Pin for manual blink button (BOTH eyes)
